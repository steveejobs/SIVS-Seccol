...
class FrontendContractTests(unittest.TestCase):
    ...
    def test_hr_workspace_integrates_time_clock_payroll_and_accessibility(self):
        ...
        self.assertIn('/js/modules/hr-management.js?v=2.2.0-hr-readiness-110', INDEX)
        self.assertIn('/js/modules/hr-management.js?v=2.2.0-hr-readiness-110', SERVICE_WORKER)
        self.assertIn('/theme/hr.css?v=2.2.0-hr-readiness-110', INDEX)
        for endpoint in (
            ...
            "/api/hr/payroll/rubrics", "/api/hr/compliance-records", "/api/hr/lifecycle-events",
        ):
        ...
        self.assertIn("Gerar arquivo AEJ para validação", HR_JS)
    ...
    def test_public_labels_use_plain_system_language(self):
        ...
        self.assertIn("Descreva o que voc", INDEX)
        self.assertIn("Buscar em todo o sistema", INDEX)
        self.assertIn("A IA pode sugerir um lance. O sistema só permite valores", TENDER_PORTAL_AGENT_JS)
    ...
    def test_inventory_uses_dedicated_ledger_reservations_and_accessible_forms(self):
        ...
        self.assertIn('HISTÓRICO PROTEGIDO', INVENTORY_JS)
        ...
        self.assertIn('/js/modules/inventory.js?v=2.2.0-plain-language-audit-107', INDEX)
        self.assertIn('/js/modules/inventory.js?v=2.2.0-plain-language-audit-107', SERVICE_WORKER)
    ...
    def test_document_items_integrate_commercial_purchase_service_and_stock_flows(self):
        ...
        self.assertIn('Registrando a saída dos produtos no estoque', WORKFLOW_ITEMS_JS)
        self.assertIn('Registrando a entrada dos produtos no estoque', WORKFLOW_ITEMS_JS)
        ...
        self.assertIn('/js/modules/workflow-items.js?v=2.2.0-plain-language-audit-107', INDEX)
        self.assertIn('/js/modules/workflow-items.js?v=2.2.0-plain-language-audit-107', SERVICE_WORKER)
    ...
    def test_tender_autonomy_is_explicit_and_does_not_fake_portal_execution(self):
        ...
        self.assertIn('A IA pode sugerir um lance. O sistema só permite valores', TENDER_PORTAL_AGENT_JS)
        self.assertIn('CAPTCHA ou autenticação em duas etapas', TENDER_PORTAL_AGENT_JS)
        ...
        self.assertIn('/js/modules/tender-portal-agent.js?v=2.2.0-plain-language-audit-107', INDEX)
        self.assertIn('/theme/tender-portal-agent.css?v=2.2.0-portal-agent-viewer-80', SERVICE_WORKER)
        self.assertIn('/js/modules/tender-portal-agent.js?v=2.2.0-plain-language-audit-107', SERVICE_WORKER)
    ...
    def test_tender_control_and_isolated_linux_worker_are_governed_and_accessible(self):
        ...
        self.assertIn('/theme/tender-control.css?v=2.2.0-plain-language-106', INDEX)
        self.assertIn('/js/modules/tender-control.js?v=2.2.0-deadline-lock-109', INDEX)
        self.assertIn('/theme/tender-control.css?v=2.2.0-plain-language-106', SERVICE_WORKER)
        self.assertIn('/js/modules/tender-control.js?v=2.2.0-deadline-lock-109', SERVICE_WORKER)
        self.assertIn('sivs-v2.2.0-portal-agent-viewer-80', SERVICE_WORKER)
        self.assertIn('tender_control_profiles', SERVER)
        self.assertIn('tender_protocol_evidence', SERVER)
        self.assertIn('deadlinePassed', TENDER_CONTROL_JS)
        self.assertIn('não é possível voltar no tempo', TENDER_CONTROL_JS.lower())
        self.assertIn('tender_deadline_passed', SERVER)
    ...
    def test_dashboard_priorities_explain_the_required_action(self):
        ...
        self.assertIn("O que precisa de atenção:", APP)
        self.assertIn("Cada item informa o que precisa de atenção", APP)
