const CACHE = 'sivs-v2.2.0-crm-followups-65';
const ASSETS = [
  ...
  '/theme/components.css?v=2.2.0-audit-legibility-49',
  ...
  '/theme/productivity.css?v=2.2.0-workspace-tabs-59', '/theme/motion.css',
  ...
  '/js/modules/control-center.js?v=2.2.0-control-center-38',
  ...
  '/app.js?v=2.2.0-crm-followups-65', '/manifest.json?v=2.2.0-mobile-21',
];
