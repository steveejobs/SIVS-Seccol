...
const ASSETS = [
  ...
  '/theme/components.css?v=2.2.0-notification-clarity-94',
  ...
  '/theme/tender-control.css?v=2.2.0-plain-language-106',
  ...
  '/theme/productivity.css?v=2.2.0-assistant-recovery-108', '/theme/motion.css',
  ...
  '/js/modules/financial-ledger.js?v=2.2.0-plain-language-audit-107',
  '/js/modules/whatsapp.js?v=2.2.0-uazapi-whatsapp-64',
  '/js/modules/workflow-items.js?v=2.2.0-plain-language-audit-107',
